        ...
        $this
            ...
            ->add(
                ...
                TextFieldOption::make()
                    ...
                    ->value(BaseHelper::hasDemoModeEnabled() ? 'test' : get_payment_setting('public', PAYSTACK_PAYMENT_METHOD_NAME))
            )
            ->add(
                ...
                TextFieldOption::make()
                    ...
                    ->value(BaseHelper::hasDemoModeEnabled() ? 'test' : get_payment_setting('secret', PAYSTACK_PAYMENT_METHOD_NAME))
            )
            ->add(
                ...
                TextFieldOption::make()
                    ...
                    ->value(BaseHelper::hasDemoModeEnabled() ? 'test' : get_payment_setting('webhook_secret', PAYSTACK_PAYMENT_METHOD_NAME))
            )
