        ...
        $this
            ...
            ->add(
                ...
                TextFieldOption::make()
                    ...
                    ->value(BaseHelper::hasDemoModeEnabled() ? 'test' : get_payment_setting('client_id', 'stripe'))
                    ->placeholder('test')
            ...
            ->add(
                ...
                TextFieldOption::make()
                    ...
                    ->value(BaseHelper::hasDemoModeEnabled() ? 'test' : get_payment_setting('secret', 'stripe'))
                    ->placeholder('test')
            ...
            ->add(
                ...
                TextFieldOption::make()
                    ...
                    ->value(BaseHelper::hasDemoModeEnabled() ? 'test' : get_payment_setting('webhook_secret', 'stripe'))
                    ->placeholder('test')
